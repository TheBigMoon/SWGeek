...
export type FilmsActionType = SetFilms | SetFilm | SortByZA | SortByAZ
...
export interface SortByAZ {type: typeof SORT_FILMS_BY_A_Z, sortByAZ: boolean}
export interface SortByZA {type: typeof SORT_FILMS_BY_Z_A, sortByZA: boolean}
